...
func TestFactsToStrings(t *testing.T) {
	facts := []kgtypes.Fact{
		{
			SourceNode: kgtypes.Entity{Name: "Alice"},
			TargetNode: kgtypes.Entity{Name: "Bob"},
			FactText:   "works with",
		},
		{
...
func TestFilterFacts(t *testing.T) {
	...
	got := FilterFacts(facts, func(f kgtypes.Fact) bool {
...
func TestSubgraph(t *testing.T) {
	detail := &kgtypes.NodeDetail{
		Node: kgtypes.GraphNode{ID: "1", Name: "Alice", Type: "Person"},
		Neighbors: []kgtypes.GraphNode{
...
func TestSubgraph_NoNeighbors(t *testing.T) {
	detail := &kgtypes.NodeDetail{
		Node: kgtypes.GraphNode{ID: "1", Name: "Lonely"},
	}
